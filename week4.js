...
let result = convertTemp(24);
console.log("Q1 : temperature in cels", result.celsius);
console.log("Q1 convertTemp to fahrenheit: ", result.Fahrenheit);
...
let inputString = "coding is cool!";
let reversing = reverseString(inputString);

console.log("Q2 reverseString:", inputString, reversing);
...
console.log("Q3 tipCalculator:", tipCalculator(22, 0.2));
...
let scores = [40, 45, 90];
console.log("Q8 calculateAverage:", calculateAverage(scores));
console.log("Q8 calculateAverage:", calculateAverage([100, 50, 75, -10, 200]));
...
console.log("Q9 getLetterGrade:", 95, getLetterGrade(88));
...
console.log(
  "Q11:",
  printClassResult("History 101", "Sara Ataey", [60, 70, 85, 87]),
);
