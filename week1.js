...
// PUT YOUR CODE HERE
let floatingPoint = 5.9;
let integer = 100;
let negative = -20;
let notANumber = 4 * "not a number";
console.log(
...
// PUT YOUR CODE HERE
let trusy = true;
console.log("Q3: The variable I made true is: ", trusy);

//The output of the above should be true.
let falsy = false;
console.log("Q3: The variable I made false is: ", falsy);
...
let studentFirstName = "Mahdi";
let studentLastName = "Ataey";
let className = "Intro Programing";
console.log(
  `my name is : ${studentFirstName} my last name is : ${studentLastName} and I am in : ${className} class.`,
);
...
console.log(`first operation result is : ${sum1}`);
console.log(`second operation result is : ${sum2}`);
...
console.log("the result is : ", answer7);
// Don't forget your console.logs!
...
let age = 33;
if (age <= 30) {
  console.log("Mahdi Age is just a number!!");
} else console.log("Mahdi you are young heart!");
// Don't forget your console.logs!
...
// PUT YOUR CODE HERE
let exampleNum = 13.3566;
let time = exampleNum * 100;
let round = Math.round(time);
let result = round / 100;
console.log(result);
...
let word1 = "Welcome ";
let word2 = "to Coding";
function biggestStringLength(first, second) {
