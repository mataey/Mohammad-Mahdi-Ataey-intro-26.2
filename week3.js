...
// PUT YOUR CODE HERE
for (let value in myPet) {
  console.log("Q3: " + value + "  " + myPet[value]);
}
...
myPet = {
  ...
  color: "white",
  describe() {
    let result = `my pet name is: ${this.name}, my pet is a: ${this.species} and her/his color is: ${this.color}`;
    return result;
  },
};
console.log("Q4: ", myPet.describe());
...
function printPets(value) {
  value.forEach((eachpet) => console.log(eachpet));
}
printPets(pets);
//---------- QUESTION 7 ----------
...
let Dog1 = new Dog("Kroger", "greyhoud", 8);
let Dog2 = new Dog("destiny ", "shepherd", 14);
console.log("Q7", Dog1);
console.log("Q7", Dog2);
...
console.log(
  "Q8: Are objects equal - different values:",
  areObjectsEqual(Dog1, Dog2),
);
console.log(
  "Q8: Are objects equal - same key and values:",
  areObjectsEqual(Dog1, dog3),
);
console.log(
  "Q8: Are objects equal - different keys:",
  areObjectsEqual(Dog1, dog4),
);
