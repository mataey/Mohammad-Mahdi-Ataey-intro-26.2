...
console.log("Q4 : ", vowelCount("I love you code."));
// ---------- QUESTION 5 ----------
...
function getElementAt(array, arrayIndex) {
...
console.log("Q8: ", insertInArray(full));
console.log("orignal array: ", full);
...
console.log("Q9 same: ", compareArrays(full, [1, 2, 3, 4, 5, 6]));
console.log("Q9 different: ", compareArrays(full, [1, 2, 3, 4, 5]));
...
console.log("Q11 : ", findEvens([10, 2, 3, 19, 7, 6, 93]));
console.log("Q11 : ", findOdds([10, 2, 3, 19, 7, 6, 93]));
...
// PUT YOUR CODE HERE
function makeSquares(value) {
  let result = [];
  for (let i = 0; i < value.length; i++) {
    result.push(value[i] * value[i]);
  }
  return result;
}
console.log("Q12 : ", makeSquares([2, 5, 8]));
...
// PUT YOUR CODE HERE
function displaySkills(value) {
  for (let skill = 0; skill < value.length; skill++) {
    console.log(value[skill]);
  }
}
displaySkills(["JavaScript", "HTML", "CSS", "Adobe", "Photoshop", "github"]);
...
function testScope() {
  ...
  // console.log(functionVar outside function); // not accessible
  // console.log(blockVar outside block); // not accessible
}
